...
public class GraphQLListValueImpl extends GraphQLValueImpl implements GraphQLListValue {

  public GraphQLListValueImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphQLValue> getValues() {
